...
export default function TrainerSummary({
  ...
  return (
    <div className="adminTable" style={wrapperStyle}>
      ...
      <div style={beginnerStyle}>
        <p style={titleStyle}>Workouts principiantes</p>
        <h2 style={valueStyle}>{beginnerWorkouts}</h2>
      </div>

      <div style={intermediateStyle}>
        <p style={titleStyle}>Workouts intermedios</p>
        <h2 style={valueStyle}>{intermediateWorkouts}</h2>
      </div>

      <div style={expertStyle}>
        <p style={titleStyle}>Workouts expertos</p>
